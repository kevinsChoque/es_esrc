...
// cabezera
        ...
        $pdf->SetFont('Arial', 'B', 9);
        $pdf->text(81,22,'Resumen del Acta de Inspeccion Interna');
        ...
        $pdf->Cell(90,$s,'-',$marco,0,'R');
        $pdf->Cell(5,$s,'-',$marco,1,'L');

        $pdf->Cell(5,$s,'-',$marco,0,'C');
        $pdf->Cell(90,$s,'NOMBRE DEL RECLAMANTE O SU REPRESENTANTE',$marco,0,'L');
        $pdf->Cell(95,$s,'',$marco,1,'C');
